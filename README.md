...
|1.+|Then, in `templates/registerUser.html` uncomment `line73` and `line74` <br/><br/>Note: To uncomment, <br/>just remove `{% comment %}` <br/> and remove `{% endcomment %}` <br/>from `line73` and `line74` | ![Guide10](/static/images/guide10.png)|
